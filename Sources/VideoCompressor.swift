...
final class VideoCompressor: ObservableObject {
    ...
    func compressVideo(inputURL: URL, musicURL: URL? = nil) async throws -> URL {
        ...
        // 2. Injeksi Audio (Musik Kustom atau Suara Asli)
        ...
        let renderWidth: CGFloat = isPortrait ? 720 : 1280
        let renderHeight: CGFloat = isPortrait ? 1280 : 720
        ...
        await MainActor.run {
            self.statusMessage = "Merender video 720p 60 FPS..."
